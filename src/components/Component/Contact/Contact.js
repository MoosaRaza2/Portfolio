                ...
                <div className="row">
                    <div className="col-md-6 col-sm-12 col-lg-5">
                        <motion.div whileInView={{ x: 0, opacity: 1 }} initial={{ x: -80, opacity: 0 }} transition={{ duration: 1, type: 'spring', delay: 0.4 }} className="left-card f-po">
                            ...
                            <h6>FIND ME WITH</h6>
                            <ul>
                                <a target={'_blank'} href="https://www.linkedin.com/in/moosa-raza-6834a31a1/"><li><RxTwitterLogo /></li></a>
                                <a target={'_blank'} href="https://www.linkedin.com/in/moosa-raza-6834a31a1/"><li><FiFacebook /></li></a>
                                <a target={'_blank'} href="https://www.linkedin.com/in/moosa-raza-6834a31a1/"><li><FiLinkedin /></li></a>
                            </ul>
