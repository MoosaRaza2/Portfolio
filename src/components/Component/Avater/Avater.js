...
import './Avater.scss';
import ava from '../../../images/dpp.jpg';
    ...
    return (
        <main className='avater'>
            <motion.div animate={{ y: 0, opacity: 1 }} initial={{ y: 50, opacity: 0 }} transition={{ duration: 0.5, type: 'spring' }} className="avater-box">
                <div className="left">
                    <motion.img animate={{ borderRadius: ["72% 78% 72% 68% / 51% 30% 70% 49% ", "43% 57% 29% 71% / 63% 40% 60% 37% ", "30% 70% 61% 39% / 63% 40% 60% 37% ", "30% 70% 61% 39% / 39% 56% 44% 61% ", "50% 50% 42% 58% / 36% 49% 51% 64% ", "48% 52% 42% 58% / 68% 37% 63% 32% "], }} transition={{ type: "spring", duration: 10, repeat: Infinity, repeatType: "mirror" }} src={ava} alt="" />
